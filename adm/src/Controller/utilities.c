...
void copy_token_to_processes_states(SendableToken *t,GlobalState * s,int processes_count )
{
	...
	{
		strcpy(   s->processes_states_array[i]->variables.state_name_array[j],t->target_process_variables.state_name_array[j]);
		s->processes_states_array[i]->variables.state_value_array[j]=t->target_process_variables.state_value_array[j];

	}
	s->processes_states_array[i]->variables.count=t->target_process_variables.count;
