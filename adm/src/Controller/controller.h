...
void check_new_state(GlobalState*, Token* t, GlobalState* owner_global_state,
		int delay_time, int delay_events);
...
int get_global_state_by_token_id(int token_id, GlobalState** global_state,
		Token** token);
