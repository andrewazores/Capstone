...
double get_distance2(double p1_altitude,double p1_lattitude,double p1_longitude,double p2_altitude,double p2_lattitude,double p2_longitude)
{
...
double get_distance(double p1_altitude,double p1_lattitude,double p1_longitude,double p2_altitude,double p2_lattitude,double p2_longitude)
{
	//http://www.movable-type.co.uk/scripts/latlong.html
	double R = 6371; // km
